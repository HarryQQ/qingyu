...
--
-- Host: localhost    Database: qingyu
-- ------------------------------------------------------
...
CREATE TABLE `log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` enum('create','update','delete','login','logout','upload','download','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other',
...
-- Dump completed on 2025-03-15 21:25:10
